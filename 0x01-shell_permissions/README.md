...
100. 100-change_owner_and_group -> a script that changes the owner to vincent and the group owner to staff for all the files and directories in the working directory.

101. 101-symbolic_link_permissions -> a script that changes the owner and the group owner of _hello to vincent and staff respectively.

102. 102-if_only -> Write a script that changes the owner of the file hello to betty only if it is owned by the user guillaume.

103. 103-Star_Wars -> a script that will play the StarWars IV episode in the terminal.
